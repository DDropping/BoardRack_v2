    ...
    <body style="margin: 0;padding: 0;background-color: #f6f9fc;">
      <center class="wrapper" style="width: 100%;background-color: #f6f9fc;padding: 40px 0;font-family: Helvetica, Arial, sans-serif, &quot;Avalon&quot;;">
        ...
        <div class="content" style="max-width: 600px;background-color: #ffffff;margin-top: 0;padding: 40px 0;">
          ...
          <a class="activateButton" href=${verificationLink} target="_blank" style="margin: 25px 0;font-size: 12px;font-family: &quot;open sans semi&quot;, Helvetica, Arial, sans-serif;color: #ffffff;text-decoration: none;border-radius: 0px;padding: 12px 18px;border: 1px solid #1a1a1a;background-color: #00458a;display: inline-block;line-height: 26px;letter-spacing: 2px;text-transform: uppercase;cursor: pointer;">
            Activate Your Account
          </a>
          <div>Or copy this link and paste in your web browser:</div>
          <br>
          <a href=${verificationLink} class="link-text" style="color: #00458a;">
