const generateInline = (username, recoverAccountUrl) => {
  return `
    ...
    <body style="margin: 0;padding: 0;background-color: #f6f9fc;">
      <center class="wrapper" style="width: 100%;background-color: #f6f9fc;padding: 40px 0;font-family: Helvetica, Arial, sans-serif, &quot;Avalon&quot;;">
        ...
        <div class="content" style="max-width: 600px;background-color: #ffffff;margin-top: 0;padding: 40px 0;">
          <div class="title" style="text-align: center;font-weight: bold;font-size: 32px;color: #1a1a1a;line-height: 36px;">Password Updated!</div>
          <div class="subtitle" style="margin-top: 20px;text-align: center;font-size: 18px;color: #1a1a1a;line-height: 18px;">
            Hi ${username}, your account's password has been updated.
          </div>
          ...
          <br>
          <a href=${recoverAccountUrl} class="link-text" style="color: #00458a;">
            <div>${recoverAccountUrl}</div>
          </a>
          <br>
